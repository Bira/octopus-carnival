...
The Coiled Spring is an amulet made of brass, about the size of a large pocket
watch. On its front, there is a relief of a snake eating its own tail, the
...
figured out it works just as well for organics. When worn by an enemy, it always
starts out full. When found as treasure, it starts out with 1d points.

The Coiled Spring might be worth around $5000 if sold off, though a dedicated
colector might pay more. Note that you can't double-dip and designate it as a
Power Item.
