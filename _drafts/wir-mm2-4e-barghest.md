...
thing I have the book where they first appear in. Their exact nature has changed
...
usually seen as a blessing from Bane. As a result, barghests often rise to
leadership positions in goblinoid society when they grow up.
...
attacks (+7 vs. AC or +5 vs. other defenses), but I guess the damage and other
effects will be as if the power had been used by the original PC. This would
make the ability worth using on high-damage powers, or those with interesting
side effects (like, say, the wizard's Sleep spell).
...
lord heals 5 HP. I think this is _per target_, so if four PCs are hit the battle
lord will heal at the start of each of their turns until they save.
...
will be interesting to find out if they learn to spot the signs. As mentioned in
